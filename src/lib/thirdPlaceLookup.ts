// FIFA 2026 World Cup Third-Place Team Assignment Lookup Table
// Source: FIFA Regulations Annex C (495 combinations)
// Key: sorted 8-letter string of qualifying groups (e.g. "ABCDEFGH")
// Value: [vs1A, vs1B, vs1D, vs1E, vs1G, vs1I, vs1K, vs1L] — which group's 3rd-place team
//        faces each group winner in the R32

// Slot order: the 8 R32 matches involving 3rd-place teams
// Index 0 = faces winner of Group A (1A)
// Index 1 = faces winner of Group B (1B)
// Index 2 = faces winner of Group D (1D)
// Index 3 = faces winner of Group E (1E)
// Index 4 = faces winner of Group G (1G)
// Index 5 = faces winner of Group I (1I)
// Index 6 = faces winner of Group K (1K)
// Index 7 = faces winner of Group L (1L)

export const THIRD_PLACE_LOOKUP: Record<string, string[]> = {
...
export function lookupThirdPlaceAssignment(advancingGroups: string[]): string[] | null {
  const key = [...advancingGroups].sort().join('');
  return THIRD_PLACE_LOOKUP[key] ?? null;
}
